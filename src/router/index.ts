...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/register-issuance',
      name: 'register-issuance',
      component: () => import('../views/RegisterIssuanceView.vue'),
      meta: {
        showHomeButton: true,
        showLeftToggle: true,
        showRightToggle: true,
    ...
    },
    {
      ...
      name: 'contract-doc-choice',
      component: () => import('../views/ContractDocChoiceView.vue'),
    ...
    },
    {
      path: '/contract/qb',
      name: 'contract-qb',
      component: () => import('../views/QBView.vue'),
      meta: {
        showHomeButton: true,
        showLeftToggle: true,
        showRightToggle: true,
    ...
    },
    {
      path: '/contract/qe',
      name: 'contract-qe',
      component: () => import('../views/QEView.vue'),
      meta: {
        showHomeButton: true,
        showLeftToggle: true,
        showRightToggle: true,
    ...
    },
    {
      ...
      component: () => import('../views/ContractPreviewView.vue'),
      meta: {
        showHomeButton: true,
        showLeftToggle: true,
        showRightToggle: true,
